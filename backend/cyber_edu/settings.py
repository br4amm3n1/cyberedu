"""
Django settings for cyber_edu project.
...
MIDDLEWARE = [
    ...
    'cyber_edu.middleware.SessionStatusMiddleware',
...
WSGI_APPLICATION = 'cyber_edu.wsgi.application'
